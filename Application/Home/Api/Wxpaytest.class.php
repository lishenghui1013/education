...
class Wxpaytest extends Base
{
    ...
    private $config = array(
        ...
        'notify_url' => 'http://127.0.0.1/education/Notifyurl/notify', /*自定义的回调程序地址*/
        'trade_type' => "APP"
    );
...
//将微信返回的结果xml转成数组
    ...
    public function postXmlCurl($xml, $url, $second = 30)
    {
        ...
        //检查公用名是否存在，并且是否与提供的主机名匹配;检查服务器SSL证书中是否存在一个公用名(common name)。
