...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIu3x6NLAqGTZg"; // AccessKeyId

        $accessKeySecret = "odhMHucO4OI5QeffwAljdiNagJXKYM"; // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("银翰科技");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_149360365");
