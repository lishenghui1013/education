...
class TextbookController extends BaseController {
    ...
    public function index()
    {
        ...
        $title = I('post.title')!==''?I('post.title'):(I('get.ttitle')!==''?I('get.ttitle'):'');//标题
